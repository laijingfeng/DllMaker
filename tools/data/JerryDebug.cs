...
namespace Jerry
{
    public class JerryDebug : MonoBehaviour
    {
        ...
        /// 输出到屏幕
        /// </summary>
        private static bool m_OutScreen = false;

        /// <summary>
        /// 输出到文件
        /// </summary>
        private static bool m_OutFile = false;

        /// <summary>
        /// 输出到控制台
        /// </summary>
        private static bool m_OutConsole = true;
        ...
        /// LOG文件目录
        /// </summary>
        private static string LOG_FILE_PATH = Application.dataPath + "/../JerryDebug.txt";//Application.persistentDataPath + "/JerryDebug.txt";
        ...
        /// </summary>
        private static Type _typeOfProtoMemberAttribute = null;
        ...
        /// <param name="typeOfProtoMemberAttribute">为了不依赖，独立设置，typeof(ProtoBuf.ProtoMemberAttribute)</param>
        public static void Set(bool console = true, bool screen = false, bool file = false, bool editor = true, Type typeOfProtoMemberAttribute = null)
        {
            _typeOfProtoMemberAttribute = typeOfProtoMemberAttribute;
            m_OutConsole = console;
            m_OutScreen = screen;
            m_DoOnGUI = m_OutScreen;
            m_OutFile = file;
            if (m_OutFile)
            {
                if (editor)
        ...
        {
            if (_typeOfProtoMemberAttribute == null)
            {
                LogWarn("Have not set typeOfProtoMemberAttribute", false);
                return obj.ToString();
            }
        ...
        private static void PrintProperties(object obj, int indent)
        {
            ...
            else
            {
                foreach (PropertyInfo property in properties)
                {
                    ...
                    Attribute attri = Attribute.GetCustomAttribute(property, _typeOfProtoMemberAttribute);
                    if (attri == null)
                    {
                        continue;
                    }
